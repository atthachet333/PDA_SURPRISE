...
export const pageMeta = {
  ...
  services: {
    title: `บริการพัฒนาระบบ เว็บไซต์ และซอฟต์แวร์${TITLE_SUFFIX}`,
    description:
      'บริการพัฒนา ERP, Payroll, HR ผ่าน LINE, ระบบเอกสารและการอนุมัติ, ระบบไฟล์กลาง (NAS), เว็บแอปพลิเคชัน, แอปมือถือ และเว็บไซต์องค์กร อธิบายจากปัญหาธุรกิจและสิ่งที่เราสร้างจริง',
    path: '/services'
  },
  solutions: {
